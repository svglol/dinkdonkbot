/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e37f026b47fc4b3867a34401d68d0ba5)
// Runtime types generated with workerd@1.20260424.1 2025-07-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RPSGame" | "HangmanGame" | "LiveStream" | "KickStreamUpdater";
	}
	interface Env {
		KV: KVNamespace;
		DB: D1Database;
		...
		ACCOUNT_ID: string;
		API_TOKEN: string;
		RPSGAME: DurableObjectNamespace<import("./src/server").RPSGame>;
		HANGMANGAME: DurableObjectNamespace<import("./src/server").HangmanGame>;
		LIVESTREAM: DurableObjectNamespace<import("./src/server").LiveStream>;
		KICK_STREAM_UPDATER: DurableObjectNamespace<import("./src/server").KickStreamUpdater>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_TOKEN" | "TWITCH_CLIENT_ID" | "TWITCH_CLIENT_SECRET" | "TWITCH_EVENT_SECRET" | "WEBHOOK_URL" | "KICK_CLIENT_ID" | "KICK_CLIENT_SECRET" | "DISCORD_GUILD_ID" | "ANALYTICS_DATASET" | "ACCOUNT_ID" | "API_TOKEN">> {}
}
