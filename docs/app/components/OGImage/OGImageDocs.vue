<template>
  <div class="flex h-full w-full flex-col justify-center bg-neutral-900">
    <svg
    ...
    <div class="pl-[100px]">
      <p
        v-if="headline"
        class="mb-4 text-[24px] font-semibold text-yellow-500 uppercase"
      >
        {{ headline }}
      </p>
      <h1
      ...
      <p
        v-if="description"
        class="w-[700px] text-[32px] leading-tight text-neutral-300"
      >
        {{ description }}
      </p>
    </div>
