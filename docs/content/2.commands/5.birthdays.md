...
| [`birthdays-config`](#birthdays-config-admin) | Admin configuration commands for birthday announcements |
...
|------------|-------------|
| [`details`](#birthdays-config-details) | Show the current birthday config |
| [`setup`](#birthdays-config-setup) | Create birthday config for this server |
| [`edit`](#birthdays-config-edit) | Update birthday config values |
| [`test`](#birthdays-config-test) | Send a test birthday announcement |
